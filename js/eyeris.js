(function ($) {
    ...
    var i18n = {
        'en-GB': {
            ...
            'myInfo': 'Hi! I am Irina, digital designer with wide experience in both graphics and web.',
        ...
        'ru-RU': {
            ...
            'myInfo': 'Привет! Я Ирина, цифровой дизайнер с большим опытом работы с графикой и вебом.',
            'showAll': 'Все работы',
            'webDesign': 'Веб',
            'printDesign': 'Принт',
            'photography': 'Фото',
            ...
            'webSkills2': 'основы HTML5, CSS3, Bootstrap',
            'webSkills3': 'основы Ui, UX',
            'print': 'Фото',
            ...
            'workExpirience': 'Работала',
            'freelanceWeb': 'фриланс веб-дизайнером',
            'freelanceWebResp1': 'разрабатывала вебсайты и промо-страницы',
            'artDirectorAquarelle': 'арт-директором',
            'AQUARELLE': 'в журнале AQUARELLE',
            'aquarelleResp1': 'руководила дизайн-отделом',
            'aquarelleResp2': 'планировала фотосессии и ретушировала фото',
            'aquarelleResp3': 'работала над концепцией и верстала журнальные публикаци',
            'aquarelleResp4': 'готовила к печати',
            'aquarelleResp5': 'разрабатывала дизайн для веб, печатной и наружной рекламы ',
            'chekhov': 'внештатным дизайнером',
            'CHEKHOV': 'в Национальном Театре Чехова',
            'chekhovResp1': 'разрабатывала дизайн афиш и брошюр',
            'chekhovResp2': 'администрировала веб-контент сайта компании',
            'seradPlus': 'младшим графическим дизайнером',
            'SERADPLUS': 'в рекламном агентстве SerAd',
            'seradPlusResp1': 'верстала и готовила к печати журнальные публикации',
            'seradPlusResp2': 'ретушировала фото',
            'seradPlusResp3': 'разрабатывала дизайн для веб, печатной и наружной рекламы ',
            'benefis': 'маркетинг-менеджером',
            'BENEFIS': 'в балетном ателье BENEFIS',
            'benefisResp1': 'обрабатывала заказы клиентов',
            'benefisResp2': 'переводила документы с англ. на рус. языки',
            'benefisResp3': 'администрировала веб-контент сайта компании',
            'previous': 'Предыдущий',
            'next': 'Следующий',
            'scrollToTop': 'наверх',
    ...
    'no-NO': {
        ...
        'myInfo': 'Hei! Jeg er Irina, digital designer med stor erfaring både i grafikk og på nettet.',
        ...
        'prepress': 'forberedelse til trykking',
        'retouch': 'foto retusjering',
        'art-direction': 'art-direction',
        'editing':'photo redigering',
        'perform': 'som frilansdesigner',
        'perform1': 'som digital designer i MNOGOLAND',
        ...
        'portfolio7': 'Desk calendar',
        'portfolio8': 'Product photography',
        'portfolio9': 'Skrivebordskalenderen',
        'portfolio10': 'Foto illustrasjon',
        'portfolio11': 'Valentinsdag, plakat',
        'portfolio13': 'Eiendomsmegling, nettside',
        ...
        'portfolio17': 'Eiendomsmegling, landingsside',
        'portfolio18': 'Shutterstock foto portefølje',
        ...
        'portfolio2Desc': 'Denne plakaten ble utviklet under reklamekampanjen på morgenmusikkprogrammet på radioen AQUARELLE 90.7 FM. Ideen er å våkne opp med energisk musikk og morsomme DJer.',
        'portfolio3Desc': 'AQUARELLE er et månedlig trykt glanset magasin for kvinner. Det handler om helse, skjønnhet, mote og personlig liv. I løpet av de 5 årene da jeg jobbet på magasinets kreative avdeling, designte jeg rundt 1,5 tusen sider, 30 magasinforsider og retusjerte utallige bilder. Det var en multitasking jobb som bestått av visuell konseptutvikling, ledelse av designavdelingen, samarbeid med fotografer og trykkerier.',
        'portfolio4Desc': 'For retusjering av et portrett bruker jeg hovedsakelig frequency separation blandet nødvendighvis med dodge&burn. Bilder ble tatt under studiene på fotografering skole.',
        'portfolio5Desc': 'Dette kortet er designet for utskrift og mailing som en invitasjon til en skjønnhetskonkurranse. Den er laget i form av en spansk fan for å matche temaet til arrangementet.',
        ...
        'portfolio8Desc': 'I took these pictures while being a student of a photography school.',
        'portfolio9Desc': 'Den årlige bedriftskalenderen for Aquarelle Magasin ble designet som en gave til abonnenter. Her er kalendere fra 2014 med designkonseptet "Jenta på magasinforside" og fra 2015 med ideen "Kvinnelig skjønnhet rundt om i verden." Magasinets ansatte fungerte som modeller, inkludert meg :)',
        'portfolio10Desc': 'Jobben med fotoillustrasjoner for et magasin krever ofte i tillegg til retusjering slike manipulasjoner som å kombinere flere bilder til en, erstatte bakgrunn, legge til objekter osv. Jeg elsket spesielt denne delen av jobben min og deltok i alle faser: fra skissereideer og planlegging et fotografering til trykk',
        'portfolio11Desc': 'Denne plakaten ble designet i sammenheng med Valentinsdagskampanje, utført av KIA MOTORS MOLDOVA og ble publisert i AQUARELLE magasin.',
        'portfolio13Desc': 'Bizon Imobil er et eiendomsfirma basert i Moldova. Oppgaven var å skape et klart grensesnitt for rask eiendomssøk og visning.',
        ...
        'portfolio14Desc': 'Copywriting byrå med et morsomt navn Copymonster. Oppgaven var å skape en morsom, fengende karakter som lett kan forklare tjenestene som tilbys med en følelse av kreativ og uformell atmosfære.',
        'portfolio14Desc2': 'Hjemmeside.',
        'portfolio14Desc3': 'Tilleggstjenester side.',
        'portfolio15Desc1': 'To landingssider for en drosjetjenester, tilgjengelig i Moskva, Russland. Den første siden har online taxi bestillingsskjema og bedriftsinformasjon. Den andre siden er for sjåfører som trenger jobb.',
        'portfolio15Desc2': 'Price-list.',
        'portfolio16Desc1': 'Landingsside med informasjon om et selskap som tilbyr juridisk bistand med avfallshåndtering lisens.',
        'portfolio17Desc1': 'Den elite eiendomsmegling i Thailand trengte en salgsfremmende side for å tiltrekke seg russespråklige turister. I designen brukte jeg store kvalitetsbilder av eksotiske landskap og attributter av øyelivet.',
        'portfolio18Desc': 'Fotografering er en av mine favoritt ting å gjøre. Dette er min måte å lagre og dele med andre de vakre tingene som omgir meg. Nylig ble jeg med i samfunnet av shutterstock-bidragsytere, hvor du kan se og laste ned arbeidene mine.',
        'portfolio19Desc': 'Enkel nettside design for en byggematerialeforhandler basert i Russland.',
        'portfolio20Desc': 'En enkel og klar landingsside som annonserer en finansiell dataoperatørtjeneste i sammenheng med de siste skattelovgivningsendringene i Russland.',
        ...
        'portfolio22Desc': 'Økologisk kosmetikk for hud og hårpleie. Den er laget av en spesiell substans basert på Altai fjell urter. Emballasjens designelementer og siden er inspirert av gamle rockmalerier som finnes i dette området.',
        'portfolio23Desc': 'This logo was designed for a digital marketing company that provides various internet promotion services, such as video and text content creation, social media marketing, etc.',
        ...
        'webSkills3': 'Ui, UX grunnleggende',
        'print': 'Grafisk',
        'printSkills1': 'commercial outdoor advertising design',
        'photo': 'Foto',
        'photoSkills1': 'fotoretusjering',
        ...
        'aquarelleResp2': 'planlagte bildeserier og retusjerte bilder',
        'aquarelleResp3': 'utviklet redaksjonell konsept, layout',
        'aquarelleResp4': 'designet reklameartikler for web, trykk og utendørs',
        'aquarelleResp5': 'forberedt til trykking',
        'chekhov': 'som deltid grafisk designer',
        'CHEKHOV': 'i Chekhov Nasjonal Teater',
        'chekhovResp1': 'designet plakater og brosjyrer',
        'chekhovResp2': 'administrert innhold på bedriftens nettside',
        'seradPlus': 'som Junior grafisk designer',
        'SERADPLUS': 'i SERAD reklamebyrå',
        'seradPlusResp1': 'designet og forberedt til trykking redaksjonell materialer',
        'seradPlusResp2': 'retusjerte bilder',
        'seradPlusResp3': 'designet reklameartikler for web, trykk og utendørs',
        'benefis': 'som Markedsføringsleder',
        'BENEFIS': 'som Benefis atelier',
        'benefisResp1': 'behandlet kundeordrer',
        'benefisResp2': 'oversatt engelsk til russisk korrespondanse',
        'benefisResp3': 'administrert innhold på bedriftens nettside',
        'previous':'<',
        'next': '>',
